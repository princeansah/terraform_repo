#aws configure --profile princeice
variable "region" { default = "ap-south-1" }
variable "profile" { default = "princeice" }
variable "availability_zone" { default = "ap-south-1a" }
variable "key_name" { default = "betterman" }
...
origin {
  domain_name = "${aws_s3_bucket.bucket1.bucket}.s3.amazonaws.com"
  origin_id = "ak" 
        }
enabled = true
...
#copy your public ID of the ec2 instance and paste in the web browser.